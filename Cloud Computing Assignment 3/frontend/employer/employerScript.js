var API_HOME = "http://localhost:5000/";
...
$('#signinForm').submit(function (e) {
  ...
  var url = API_HOME + "employer/signin/" + $('#signinid').val();
  console.log(url);
...
$('#addEmployeeForm').submit(function (e) {
  ...
  var xttp = new XMLHttpRequest();
  var url = API_HOME + "employer/addemployee";
  console.log(url);
...
$('#brokerForm').submit(function (e) {
  ...
  var xttp = new XMLHttpRequest();
  var url = API_HOME + "broker/addemployer/" + $('#inputBrokerID').val()+"/"+$('#inputEmployeeId').val();
  xttp.open("PUT", url, true);
  xttp.onreadystatechange = function () {
    if (xttp.readyState == XMLHttpRequest.DONE) {
      console.log(xttp.response)
